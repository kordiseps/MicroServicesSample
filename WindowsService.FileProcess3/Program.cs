...
namespace WindowsService.FileProcess3
{
    class Program
    {
        static void Main(string[] args)
        {
            HostFactory.Run(configure =>
            {
                ...
                configure.SetServiceName("FileProcess3");
                configure.SetDisplayName("File Process 3 Service");
                configure.SetDescription("File Process 3 Service Açıklaması");
    ...
    public class MyService
    {
        ...
        {
            bus.Start();
            Console.WriteLine("FileProcess3 started.");
        }
        public void Stop()
        {
            bus.Stop();
            Console.WriteLine("FileProcess3 Stopped.");
        }
    }
